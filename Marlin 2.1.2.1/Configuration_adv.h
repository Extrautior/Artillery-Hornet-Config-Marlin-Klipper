...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_Y  23.2          // (Hz) The default dominant resonant frequency on the Y axis.
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 120*60, 120*60, 20*60, 5*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
